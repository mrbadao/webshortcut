...
angular.module('iceWebShortcut.services', [])
		.factory('iceWebShortcutAPIservice', function ($http) {
					...
					var $objApplicationsData = [
						{
							appId: 1,
							appImageUrl: "app_ico/origin/message/120x120.png",
						...
						{
							appId: 3,
							appImageUrl: "app_ico/origin/music/120x120.png",
							referenceUrl: "music://",
							name: "ミュージック"
						},
						{
							appId: 4,
							appImageUrl: "app_ico/origin/app-setting/120x120.png",
							referenceUrl: "app-settings://",
							name: "写真"
						},
						{
							appId: 5,
							appImageUrl: "app_ico/origin/videos/120x120.png",
							referenceUrl: "videos://",
							name: "ビデオ"
						},
						{
							appId: 6,
							appImageUrl: "app_ico/origin/maps/120x120.png",
							referenceUrl: "maps://",
							name: "マップ"
						},
						{
							appId: 7,
							appImageUrl: "app_ico/origin/calshow/120x120.png",
							referenceUrl: "calshow://",
							name: "カレンダー"
						},
						{
							appId: 8,
							appImageUrl: "app_ico/origin/youtube/120x120.png",
							referenceUrl: "youtube://",
							name: "YouTube"
						},
						{
							appId: 9,
							appImageUrl: "app_ico/origin/itms-apps/120x120.png",
							referenceUrl: "itms-apps://",
							name: "App Store"
						},
						{
							appId: 10,
							appImageUrl: "app_ico/origin/ibooks/120x120.png",
							referenceUrl: "ibooks://",
							name: "iBooks"
						},
						{
							appId: 11,
							appImageUrl: "app_ico/origin/itms/120x120.png",
							referenceUrl: "itms://",
							name: "iTunes Store"
						},
						{
							appId: 12,
							appImageUrl: "app_ico/origin/line/120x120.png",
							referenceUrl: "line://",
							name: "LINE"
						},
						{
							appId: 13,
							appImageUrl: "app_ico/origin/twitter/120x120.png",
							referenceUrl: "twitter://",
							name: "Twitter"
						},
						{
							appId: 14,
							appImageUrl: "app_ico/origin/fb/120x120.png",
							referenceUrl: "fb://",
							name: "Facebook"
						},
						{
							appId: 15,
							appImageUrl: "app_ico/origin/google/120x120.png",
							referenceUrl: "google://",
							name: "Google"
						}
					];
